...
const emailVerificationMailgenContent = (username , verificationUrl)=>{
    return {
        body:{
            ...
            outro:"Need help, or have qquetsion? just reply to this email,we'd love to help."
        },
    }
}
...
const forgotPasswordMailgenContent = (username , passwordResetUrl)=>{
    return {
        body:{
            ...
            outro:"Need help, or have quetsion? just reply to this email,we'd love to help."
        },
    }
}
